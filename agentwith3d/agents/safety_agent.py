...
class SafetyAgent:
    ...
    def __init__(self):
        """Initializes the Safety Agent with a Gemini Client."""
...
"""
        ...
        # Generate structured safety report from Gemini
        safety_result: SafetyAnalysis = self.client.generate_structured(
            prompt=prompt,
